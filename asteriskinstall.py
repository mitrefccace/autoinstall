...
subprocess.call(['cp', '-r', 'asterisk-configs', '/etc/asterisk'], cwd = '/root/asterisk')
subprocess.call(['cp', '-r', 'asterisk-videos-audios/sounds', '/var/lib/asterisk/sounds/'], cwd = '/root/asterisk')
